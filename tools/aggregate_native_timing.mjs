...
export function formatTimingAggregate(aggregate, { limit = null } = {}) {
  const lines = [
    ...
    "",
    "optimizationsは文書が計測した最適化集合である。集合が違う文書は測定範囲が違うため、",
    "同じfixtureでも集合ごとに別行として集約する（混ぜて中央値を出さない）。",
    "",
    "| platform | fixture | optimizations | observations | median total | median official | median interpreter |",
    "| --- | --- | --- | ---: | ---: | ---: | ---: |",
    ...(limit === null ? aggregate.fixtures : aggregate.fixtures.slice(0, limit)).map((fixture) =>
      `| ${fixture.platform} | ${fixture.id} | ${fixture.optimizations ?? "-"} | ${fixture.observations} | ${formatMs(fixture.medianTotalMs)} | ${formatMs(fixture.medianOfficialMs)} | ${formatMs(fixture.medianInterpreterMs)} |`),
    "",
