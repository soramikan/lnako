...
requireText(await read("docs/CI.md"), "**51 matrix job＋変更分類・軽量検証・3後段job、合計56 job**", "CI.md");
...
console.log(`現行ドキュメント検査: 成功 (standard native=${standardStatuses.native}, compat-js=${standardStatuses["compat-js"]}, evidence verified=${evidenceStates.verified}/${evidence.commandCount}, docs表 verified=${evidenceStates.verified}, CI=56 jobs)`);
