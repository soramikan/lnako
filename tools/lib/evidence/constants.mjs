...
export const dispatchEvidenceFollowUpPaths = new Set([
  ...
  "benchmarks/comparison/results/linux-x64.json",
  "benchmarks/comparison/results/linux-x64.md",
  "benchmarks/comparison/results/macos-arm64.json",
  "benchmarks/comparison/results/macos-arm64.md",
  "benchmarks/comparison/results/windows-x64.json",
  "benchmarks/comparison/results/windows-x64.md",
  "docs/RELEASE.md",
