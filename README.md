...
標準prototype methodの関数値を解決します。receiver付きmethod呼出しとproperty identityは未実装境界として
`TODO: aot-byte-buffer-value`に記録し、`native-system-byte-buffer-direct-properties`で公式7経路を比較します。
