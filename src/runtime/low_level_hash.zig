...
test "標準テストベクタ（空・短文）を逐次計算で得る" {
    const cases = [_]struct { name: []const u8, input: []const u8, expected: []const u8 }{
        ...
        .{ .name = "sha224", .input = "abc", .expected = "23097d223405d8228642a477bda255b32aadbce4bda0b3f7e36c9da7" },
        .{ .name = "sha384", .input = "abc", .expected = "cb00753f45a35e8bb5a03d699ac65007272c32ab0eded1631a8b605a43ff5bed8086072ba1e7cc2358baeca134c825a7" },
        .{ .name = "sha512-224", .input = "abc", .expected = "4634270f707b6a54daae7530460842e20e37ed265ceee9a43e8924aa" },
        .{ .name = "sha512-256", .input = "abc", .expected = "53048e2681941ef99b2e29b76b4c7dabe4c2d0c634fc6d46e0e2f13107e7af23" },
        .{ .name = "md5-sha1", .input = "abc", .expected = "900150983cd24fb0d6963f7d28e17f72a9993e364706816aba3e25717850c26c9cd0d89d" },
        .{ .name = "sha3-224", .input = "abc", .expected = "e642824c3f8cf24ad09234ee7d3c766fc9a3a5168d0c94ad73b46fdf" },
        .{ .name = "sha3-256", .input = "abc", .expected = "3a985da74fe225b2045c172d6bd390bd855f086e3e9d525b46bfe24511431532" },
        .{ .name = "sha3-384", .input = "abc", .expected = "ec01498288516fc926459f58e2c6ad8df9b473cb0fc08c2596da7cf0e49be4b298d88cea927ac7f539f1edf228376d25" },
        .{ .name = "sha3-512", .input = "abc", .expected = "b751850b1a57168a5693cd924b6b096e08f621827444f70d884f5d0240d2712e10e116e9192af3c91a7ec57647e3934057340b4cf408d5a56592f8274eec53f0" },
        .{ .name = "blake2b512", .input = "abc", .expected = "ba80a53f981c4d0d6a2797b69f12f6e94c212f14685ac4b74b12bb6fdbffa2d17d87c5392aab792dc252d5de4533cc9518d38aa8dbf1925ab92386edd4009923" },
        .{ .name = "blake2s256", .input = "abc", .expected = "508c5e8c327c14e2e1a72ba34eeb452f37458b209ed63a294d999b4c86675982" },
        .{ .name = "shake128", .input = "abc", .expected = "5881092dd818bf5cf8a3ddb793fbcba7" },
        .{ .name = "shake256", .input = "abc", .expected = "483366601360a8771c6863080cc4114d8db44530f8f1e1ee4f94ea37e78b5739" },
    };
