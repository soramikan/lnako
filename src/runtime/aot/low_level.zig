...
pub fn pluginContext(runtime: *Runtime) low_level_context.Context {
    return .{
        .stream = .{
            ...
            .seekDataFileFn = stream.pluginSeekDataFile,
            .seekHoleFileFn = stream.pluginSeekHoleFile,
            .allocateFileFn = stream.pluginAllocateFile,
        },
        .hash = .{
            .context = runtime,
        ...
        .fs = .{
            ...
            .statfsFn = fs.pluginStatfs,
            .reflinkFn = fs.pluginReflink,
        },
        .dir = .{
            .context = runtime,
...
pub fn lowLevelFileBuiltin(runtime: *Runtime, command: aot_builtin.Command, arguments: []const Value) !Value {
    ...
    return switch (command) {
        ...
        .low_level_statfs => fs.statfsBuiltin(runtime, arguments),
        .low_level_reflink => fs.reflinkBuiltin(runtime, arguments),
        .low_level_seek_data => stream.seekDataBuiltin(runtime, arguments),
        .low_level_seek_hole => stream.seekHoleBuiltin(runtime, arguments),
        .low_level_fallocate => stream.allocateBuiltin(runtime, arguments),
