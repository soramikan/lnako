...
追跡中の`compat/v3.7.24/evidence.json`は`verified: 0`、`trace-confirmed-unattested: 303`を維持する。catalog再生成時の`--historical-commit`は
