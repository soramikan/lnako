...
- `compat/v3.7.24/dispatch-coverage-evidence.json`（30 fixture・1,688 siteのサンプルdispatch監査。catalogへ接続するのは17 entryのみ）
