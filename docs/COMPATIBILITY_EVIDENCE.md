...
fixture coverageは `paired: 523`、`compat-js-only: 4`、その他の状態は0です。fixture inventoryは合計747件、native AOT 427件、Interpreter 330件、QuickJS 9件です。inventoryの分類は重複するため、数値を足してfixture総数にしません。
