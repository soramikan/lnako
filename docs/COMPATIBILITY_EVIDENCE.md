...
- `compat/v3.7.24/dispatch-coverage-evidence.json`（46 fixture・1,826 siteのサンプルdispatch監査。catalogへ接続する350 native entryを含む。U06のarchive helper、U08のstdin fixture、U09のnetwork topology fixture、U10/U11/U12/U13のloopback HTTP fixtureを含む）
...
`trace-confirmed-unattested` 481、`unverified` 46です。
